...
namespace cc
{
    ...
    */
    ...
    struct OPKT : Base
    {
        ...
        /* *** Neu ab XX.09.04 ***                     */                                               //
#ifdef FLP                                                                                              //
        /*  10:  57 - 66  10              %10c  %d     */ char MS_LinkChar[10 + 1];                     // MS-Link (nur von FLP verwendet, irrelevant fuer Berech- nungsverhalten)
    ...
    struct OLIN : Base
    {
        ...
        /*  *** Neu ab XX.09.04 ***                */                                               //
#ifdef FLP                                                                                          //
        /*  8:  26 - 35   10               %10c %d */ char MS_LinkChar[10 + 1];                     // MS-Link (nur von FLP verwendet, irrelevant fuer Berech- nungsverhalten)
