...
struct INFO : Base
{
    ...
    INFO()
        : DSK{ "" }, KZProgram{ "" }, LetzeAenderung{ "" }, BerechnungsModus{ 0 }
    {
    }
    INFO(
        std::string DSK, std::string KZProgram, std::string LetzeAenderung, int BerechnungsModus)
        : DSK(DSK), KZProgram(KZProgram), LetzeAenderung(LetzeAenderung), BerechnungsModus(BerechnungsModus)
    {
    }
    virtual ~INFO() {};
};
...
struct INFS : Base
{
    ...
    INFS()
        : DSK{}, DatZeitProgrAend{}, DatZeit263EingDatAend{}
    {
    }
    virtual ~INFS() {}
};
...
struct KET2 : Base
{
    ...
    /*        5 -  6       1
    /*    2   7 -  9       3    */
    char KettenindexChar[3 + 1];                                                       // Kettenindex (laufende Nummer)
    /*    2   7 -  9       3    */ int KettenindexInt;                                 // Kettenindex (laufende Nummer)
...
struct EZLA : Base
{
    ...
    /*       5 -  6      2
    /*    2  7 -  9      3  */
    char LastindexChar[1 + 1];                                           // Lastindex (laufende Nummer)
    ...
    /*      16 - 16      1
    /*    5 17 - 17      1  */
    char Lasttyp[1 + 1];                                                 // Lasttyp (‘F’=Feldlast, ‘S’=Streckenlast, ‘P’=Punktlast)
    /*      18 - 18      1
    /*    6 19 - 19      1  */
    char KennungLastEndzustand[1 + 1];                                   // Kennung ‘X’ - Last auf Endzustand
...
struct SLK2 : Base
{
    ...
    /*          2     5 -   7         3
    /*   2:     3     8 -  11         4     */
    char SeilkurvenindexChar[4 + 1];                                                                   // Seilkurvenindex (laufende Nummer)
    /*   2:     3     8 -  11         4     */ int SeilkurvenindexInt;                                 // Seilkurvenindex (laufende Nummer)
...
struct OBFL : Base
{
    ...
    /*   2 :   7 -  9   3                 %3c   %d   */
    char Flaechenindex_Teil_1_Char[3 + 1];                                            // Flächenindex Teil 1 (Einer- bis Hunderterstellen)
    /*   2 :   7 -  9   3                 %3c   %d   */ int Flaechenindex_Teil_1_Int; // Flächenindex Teil 1 (Einer- bis Hunderterstellen)

    /*        10 - 10   1                 %*1c                        //

    /*   3 :  11 - 13   3                 %3c   %d   */
    char KreuzungsobjektindexTeil_1_Char[3 + 1];                                            // Kreuzungsobjektindex Teil 1 (Einer- bis Hunderterstellen)
    /*   3 :  11 - 13   3                 %3c   %d   */ int KreuzungsobjektindexTeil_1_Int; // Kreuzungsobjektindex Teil 1 (Einer- bis Hunderterstellen)
